...
const Cards = [
  {
  text:"Therapist",
  img:"https://img.freepik.com/free-vector/open-mind-psychotherapy-concept-with-treatment-effect-symbols-flat-vector-illustration_1284-78165.jpg?t=st=1750864715~exp=1750868315~hmac=d7f7b054bada65226285e1ac5fcee758ac8a9f3d57f864789b89b7159afb9498&w=1380",redirection:'/Therapist'
  },
  {
  text:"Jornaling",
  img:"https://img.freepik.com/free-vector/hand-drawn-essay-illustration_23-2150320909.jpg?t=st=1750864358~exp=1750867958~hmac=6c8b298369f7ce319902c1edc4a0cc1662de54611ac11e56765ad22e39fa1069&w=1380",
  redirection:'/Journal'
  },
  {
  text:"Promodoro",
  img:"https://img.freepik.com/premium-vector/financial-clock_442409-2093.jpg?w=1380",
  redirection:'/promodoro'
  },
  {
  text:"Ai Therapist",
  img:"https://img.freepik.com/free-vector/innovation-concept-illustration_114360-5848.jpg?t=st=1750864905~exp=1750868505~hmac=1551e5daf60a38484325499f18f305888f4f2c0ff82e581249f41bc41a669ed7&w=1380",
  redirection:'/Ai'
},
]
...
const page = () => {
  ...
  const { userData, trackMood, resetMood } = useData();
  const { temp } = useTemp();
      ...
      flex-col md:flex-row items-center justify-between'>
        ...
        >
          {
            Tracker.map((val,idx)=>(
              ...
              onClick={()=>{setRenderComp(val.renderComponent);setButtonVisible(val.type)}} 
              >
        ...
        <AnimatePresence>
          {renderComp !== null && (
            ...
            >
              <div className='flex flex-col bg-white h-[400px] w-[280px] rounded-2xl sm:w-auto relative border-2  border-gray-100 shadow-2xl'>
              ...
              {renderComp}
              {
                ...
                <div className='w-full flex justify-center items-center m-3'>
                  ...
                  onClick={
                    ()=>{
                      userData.length >= 7 ? resetMood() : null;
                      trackMood(temp)
                      setRenderComp(null)
                    }}
                  >
      ...
      <div className=' w-screen relative justify-center flex flex-wrap p-1 sm:p-4 mt-80 md:mt-20 '>
        {
          Cards.map((val,idx)=>(
            ...
            onClick={()=>router.push(`${val.redirection}`)}
          >
